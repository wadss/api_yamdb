# Generated by Django 3.2 on 2024-02-21 19:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveIntegerField(default=0, validators=[django.core.validators.MinValueValidator(1, message='Оценка меньше 1 запрещена'), django.core.validators.MaxValueValidator(10, message='Оценка больше 10 запрещена')], verbose_name='Оценка на произведение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='reviews.review', verbose_name='Отзыв комментария')),
            ],
            options={
